...
class IjaraUy(models.Model):
    ...
    number_of_rooms = models.CharField(choices=Xonalar, verbose_name='Xonalar Soni')
    number_of_beds = models.CharField( choices=Yotoqlar, verbose_name='Yotoqlar soni')
    gender = models.CharField(choices=GENDER_CHOICES, verbose_name='Kim uchun' )
